...
def FGvsSG_xErrL2L2_test1_smooth_type2(dir_fig, stabParamsType, showPlot, savePlot, plotId):
    ndim = 2
    ...
    if plotId == 1:
        ...
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_smooth_type2_deg1_v.eps"
        myPlotDict['ylim'] = [5e-4, 2]
        ...
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_smooth_type2_deg1_sigma.eps"
        myPlotDict['ylim'] = [5e-3, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
        ...
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_smooth_type2_deg1.eps"
        myPlotDict['ylim'] = [5e-3, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
    ...
    if plotId == 2:
        ...
        myPlotDict['ylabel'] = r'Rel. error $\left|| v - \hat{v}_h \right||_{L^2(\Omega\times\{T\})}$ [log]'
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_smooth_type2_deg2_v.eps"
        myPlotDict['ylim'] = [1e-6, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
        ...
        myPlotDict[
            'ylabel'] = r'Rel. error $\left|| \mathbf{\sigma} - \hat{\mathbf{\sigma_h}} \right||' \
                        r'_{L^2(\Omega\times\{T\})^{%d}}$ [log]' % ndim
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_smooth_type2_deg2_sigma.eps"
        myPlotDict['ylim'] = [1e-5, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
        ...
        myPlotDict['ref_data_labels'] = ['$O(M_L^{-1})$', '$O(M_L^{-0.67})$']
        myPlotDict['ylabel'] = r'Total error $\mathcal{E}$ [log]'
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_smooth_type2_deg2.eps"
        myPlotDict['ylim'] = [1e-5, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
...
if __name__ == '__main__':
    ...
    plotId_ = 2
    stabParamsType_ = 3
    FGvsSG_xErrL2L2_test1_smooth_type2(dir_fig_, stabParamsType_, showPlot_, savePlot_, plotId_)
