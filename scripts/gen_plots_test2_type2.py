...
def FGvsSG_xErrL2L2_test1_singular_type2(dir_fig, stabParamsType, showPlot, savePlot, plotId):
    ndim = 2
    ...
    # SG; L0t = 0, T = 1
    # deg_x = deg_t = 1; L0x = 0
    f1 = '../output/waveO1/type2/stabParams' + str(
        stabParamsType) + '/runSG_test2_bisectionRefined_xErrL2L2_degx1_degt1.txt'
    ...
    ref_const = 4e+1
    ref_errL2.append(ref_const / ndof[-1] ** 0.5)

    ref_const = 2e+1
    ref_errL2_v.append(ref_const / ndof[-1] ** 0.5)

    ref_const = 2e+1
    ref_errL2_sigma.append(ref_const / ndof[-1] ** 0.5)

    # deg_x = deg_t = 2; L0x = 0
    f2 = '../output/waveO1/type2/stabParams' + str(
        stabParamsType) + '/runSG_test2_bisectionRefined_xErrL2L2_degx2_degt2.txt'
    ...
    # FG; T = 1
    # deg_x = deg_t = 1
    f3 = '../output/waveO1/type2/stabParams' + str(
        stabParamsType) + '/runFG_test2_bisectionRefined_xErrL2L2_degx1_degt1.txt'
    ...
    ref_const = 1e+1
    ref_errL2.append(ref_const / ndof[-1] ** 0.33)

    ref_const = 5e+0
    ref_errL2_v.append(ref_const / ndof[-1] ** 0.33)

    ref_const = 5e+0
    ref_errL2_sigma.append(ref_const / ndof[-1] ** 0.33)

    # deg_x = deg_t = 2
    f4 = '../output/waveO1/type2/stabParams' + str(
        stabParamsType) + '/runFG_test2_bisectionRefined_xErrL2L2_degx2_degt2.txt'
    ...
    if plotId == 1:
        ...
        myPlotDict['ref_data_labels'] = ['$O(M_L^{-0.5})$', '$O(M_L^{-0.33})$']
        myPlotDict['ylabel'] = r'Rel. error $\left|| v - \hat{v}_h \right||_{L^2(\Omega\times\{T\})}$ [log]'
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_singular_type2_deg1_v.eps"
        myPlotDict['ylim'] = [1e-2, 2]
        ...
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_singular_type2_deg1_sigma.eps"
        myPlotDict['ylim'] = [1e-2, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
        ...
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_singular_type2_deg1.eps"
        myPlotDict['ylim'] = [1e-2, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
    ...
    if plotId == 2:
        ...
        myPlotDict['ylabel'] = r'Rel. error $\left|| v - \hat{v}_h \right||_{L^2(\Omega\times\{T\})}$ [log]'
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_singular_type2_deg2_v.eps"
        myPlotDict['ylim'] = [1e-4, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
        ...
        myPlotDict[
            'ylabel'] = r'Rel. error $\left|| \mathbf{\sigma} - \hat{\mathbf{\sigma_h}} \right||' \
                        r'_{L^2(\Omega\times\{T\})^{%d}}$ [log]' % ndim
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_singular_type2_deg2_sigma.eps"
        myPlotDict['ylim'] = [1e-4, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
        ...
        myPlotDict['ref_data_labels'] = ['$O(M_L^{-1})$', '$O(M_L^{-0.67})$']
        myPlotDict['ylabel'] = r'Total error $\mathcal{E}$ [log]'
        myPlotDict['outFileName'] = dir_fig + "FGvsSG_test1_singular_type2_deg2.eps"
        myPlotDict['ylim'] = [1e-4, 2]
        plotData(data_x, data_y, ref_data_y, myPlotDict)
...
if __name__ == '__main__':
    ...
    plotId_ = 1
    stabParamsType_ = 4
    FGvsSG_xErrL2L2_test1_singular_type2(dir_fig_, stabParamsType_, showPlot_, savePlot_, plotId_)
